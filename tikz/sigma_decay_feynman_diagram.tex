%%T Sigma decay Feynman diagram.
%%D A Feynman diagram showing sigma decay. I had used this diagram in
%%D One of my particle Physics homework.
%%G tikz, feynman, decay
\begin{tikzpicture}
    \begin{feynman}
        \vertex (a);
