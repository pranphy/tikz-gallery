%%T Neutrino mass hierarchy
%%D Figure depicting the mass hierarchy of neutrinos with two possible
%%D mass ordering, normal mass ordering, and inverted mass ordering.
%%G neutrino, tikz, mass, physics
\tikzset{
